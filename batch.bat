...
load --module 3 ../spl/spl_progs/module_3.xsm
...
load --exec ../expl/samples/asg2_s27.xsm
load --exec ../expl/samples/asg3_s27.xsm
load --exec ../expl/samples/asg4_s27.xsm
load --exec ../expl/samples/pgm1.xsm
load --exec ../expl/samples/pgm2.xsm
